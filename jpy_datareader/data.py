...
from jpy_datareader.gbizinfo import corporate_numberReader
...
__all__ = [
    ...
    "get_data_gbizinfo_corporate_number",
...
def get_data_gbizinfo_corporate_number(*args, **kwargs):
    return corporate_numberReader(*args, **kwargs).read()
...
def DataReader(
    ...
    if data_source == "gbizinfo-corporate_number":
        return corporate_numberReader(
            corporate_number=name,
            api_key=api_key,
            retry_count=retry_count,
            pause=pause,
